export const PROVIDER_ID = "nextcaptcha";
import * as types from "../types/plugin";

import Debug from "debug";
const debug = Debug(`puppeteer-extra-plugin:recaptcha-nextcaptcha:${PROVIDER_ID}`);

import nextcaptcha_api from "./nextcaptcha-api";

const solver = new nextcaptcha_api();
